...
import { getFoodTileId } from '../utils/ids';
      ...
      <div className="card foods-gallery-card">
        ...
        <div className="gallery-grid">
          {filteredFoods.map((food, index) => {
            const id = getFoodTileId(food, index);
            return <GalleryTile key={String(id)} imageUrl={food.imageUrl} fallbackText={food.name || 'Unnamed food'} isSelected={String(id) === String(selectedId)} onClick={() => setSelectedId(String(id))} />;
          })}
        </div>
